...
class ControllerSokoban :
    ...
    def checkWin(self):
        mainPath = os.getcwd()+"/Assets/Sounds"
        self.sound = QSound(mainPath + "/win.wav")
    ...
    def pushCrates(self,direction, crate):
        mainPath = os.getcwd()+"/Assets/Sounds"
        self.truc = QSound(mainPath + "/crateOnStar.wav")
        ...
        if(move in self.__model.getStars() and move not in self.__model.getCrates()):
    ...
    def teleportOn(self):
        mainPath = os.getcwd()+"/Assets/Sounds"
        self.sound = QSound(mainPath + "/teleport.wav")
    ...
    def movePlayer(self,direction):
        if self.__model is not None :
            mainPath = os.getcwd()+"/Assets/Sounds"
            self.dead = QSound(mainPath + "/dead.wav")
